...
import OrderCanceled from './ComOrderTableRequest/OrderCanceled';
import OrderReturned from './ComOrderTableRequest/OrderReturned';
...
export default function TableOrderRequest() {
