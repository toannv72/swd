...
export default function OrderShipped({ activeTab }) {
    ...
    const processing = () => {
        putData('customOrder/admin/put', 'Delivered', { orders: [orderRequestDefault.id] })
            .then((e) => {
                setDataRun(!dataRun);
            })
    ...
    const sttCanceled = () => {
        putData('customOrder/admin/put', 'Returned', { orders: [orderRequestDefault.id] })
            .then((e) => {
    ...
    const processingS = () => {
        putData('customOrder/admin/put', 'Delivered', { orders: selected })
            .then((e) => {
                setDataRun(!dataRun);
            })
            .catch(err => console.log(err))
    ...
    const canceledS = () => {
        putData('customOrder/admin/put', 'Returned', { orders: selected })
            .then((e) => {
                setDataRun(!dataRun);
    ...
    useEffect(() => {
        setTimeout(() => {
            getData('customOrder/admin/shipped', {})
                .then((data) => {
    ...
    return (
        <>
            ...
            <Modal title="Chấp nhận đơn hàng này"
                ...
                <div className='text-lg p-6'>Bạn có chắc chắn muốn chuyển qua hoàn thành?</div>
                <div className='flex'>
                    <ComButton
                        type="primary"
                        danger
